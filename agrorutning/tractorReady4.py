...
class TractorSimulator:
    ...
    def create_widgets(self):
        ...
        tk.Label(coord_entry_frame, text="X:", fg='white', bg='#160B0B', font=('Comic Sans MS', 14)).grid(row=0, column=0, sticky="e", pady=2)
        ...
        tk.Label(coord_entry_frame, text="Y:", fg='white', bg='#160B0B', font=('Comic Sans MS', 14)).grid(row=1, column=0, sticky="e", pady=2)
    ...
    def animate_tractor(self):
        ...
        if abs(angle_diff) > 5:
            ...
            if abs(current_steering) <= STEERING_RETURN_RATE:
                ...
                self.tractor['steering_angle'] = current_steering - STEERING_RETURN_RATE * (1 if current_steering > 0 else -1)
